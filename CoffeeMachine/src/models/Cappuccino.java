...
public class Cappuccino implements BeverageFactory {
    static String name = "Cappuccino";
    CoffeeBeans coffeeBeans = new CoffeeBeans(40);
    Milk milk = new Milk(20);
    Water water = new Water(40);
